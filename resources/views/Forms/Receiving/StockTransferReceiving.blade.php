                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-primary">
                            <a href="#" class="text-primary font-size-h4"> Transmittal Receiving Records </a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card card-custom gutter-b">
                            <div class="card-header  align-items-center flex-wrap py-5 h-auto">
                                ...
                                <div
                                    class="col-12 col-sm-6 col-xxl-8 order-2 order-xxl-3 d-flex align-items-center justify-content-sm-end text-right my-2">
...
@section('script')
    <script>
        ...
        function getIntransit() {
            axios.get(`/get-receiving-in-transit-list/{{ session()->get('user')->branch }}`)
                ...
                $(`#in-transit_list`).append(`
                    ...
                    <div class="d-flex align-items-center mt-2">
                        ...
                        <div class="symbol symbol-light-success symbol-40 mr-3">
                            ...
                            <span class="text-dark-50 p-10" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 16px;padding-top: 40px;line-height: 1;"><b> ${value.from_department_code}</b></span>
                            </i>
                        </div>
                        <span class="font-weight-bold text-warning text-hover-primary" style="font-size: 16px"> ${value.Intransit_no} </span>
                        </div>

                    </div>
                    <div style="width:30%" class="flex-grow-1 mt-2 mr-5">
                        <div>
                        <span style="color:#0096FF" class="font-weight-bolder font-size-lg mr-2"> ${value.purpose} : </span>
                        ...
                        <span class="text-nowrap ml-5"><small> To: <strong> ${ moment(value.created_at).fromNow()} </strong></small></span>
                        </div>
                    </div>
