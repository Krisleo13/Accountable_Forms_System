                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header align-items-center flex-wrap py-5 h-auto">
                                ...
                                <div  class="col-12 col-sm-6 col-xxl-8 order-2 order-xxl-3 d-flex align-items-center justify-content-sm-end text-right my-2">
                                    ...
                                    <span onclick="getPO()" class="btn btn-default mr-2" data-toggle="tooltip"
                                        title="Reload list">
                            ...
                            <div class="card-body px-4">
                                <table
                                    ...
                                    style="text-align: center;max-width: fit-content" id="req_id">
                                </table>
                            </div>
...
@section('script')
    <script>
        ...
        let po_table = $('#req_id').DataTable({
            ...
            columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        return `<h4><a href='/purchase-order-details/${data.po_no}'><b class='text-warning'>${data.po_no}</b></a></h4>`;
                    }
                },
                {
                    data: null,
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<b class='text-dark-2' > ${data.remarks} </b>`;
                    }
                },
                {
                    data: null,
        ...
        function getPO() {
            axios.get('/get-purchase-order').then(function(response) {
