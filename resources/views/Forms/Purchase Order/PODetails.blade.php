                 ...
                 <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-primary">
                            <a href="#" class="text-primary font-size-h4"> Purchase Order Details </a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                <div class="d-flex flex-column flex-md-row">
                    <div class="flex-md-row-fluid" >
                        <div class="card card-custom gutter-b" id="kt_todo_view" style="">
                                ...
                                <div class="d-flex align-items-center my-2">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-light-primary symbol-40 mr-3">
                                            <i class="flaticon-interface-11 icon-3x text-success"></i>
                                        </div>

                                        <div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
                                            <div class="d-flex">
                                                <span class="cursor-pointer font-size-h3 font-weight-bolder text-dark-75 ">
                                                    <b id="tcode">{{ $po->po_no }} </b>
                                                </span>
                                                {{-- <div class="font-weight-bold font-size-h5 text-muted justify-content-between">
                                ...
                                <div class="d-flex align-items-center justify-content-end text-right my-2">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center py-1">
                                            ...
                                            {{-- buttons --}}
                                                    @if ($po->status == 5)
                                                        <button onclick="ApprovedPO(17,'PO Approved')" type="button"
                                                            class="btn btn-light-success mr-2">
                                                            Approved  <i class="flaticon-like icon-lg"></i>
                                                        </button>

                                                        <button onclick="ApprovedPO(21, 'PO Disapproved')" type="button"
                                                            class="btn btn-light-danger mr-2">
                                                           Disapproved  <i class="flaticon-like icon-lg" style="transform: scaleY(-1);"></i>
                                                        </button>

                                                    @else
                                                        @if ($po->status != 8)
                                                            <button type="button" title="Purchase Request Status" onclick="UpdateStatus()"
                                                                class="btn btn-light-primary mr-2">Request For Approval
                                                            </button>
                                                        @else
                                                            <span class="label label-lg label-light-success label-inline text-uppercase font-weight-bold py-5 mr-3"  data-toggle="tooltip" data-placement="bottom" >
                                                                {{ $po->state }}
                                                            </span>
                                                        @endif
                                                    @endif

                                                    @if ($po->status != 8 && $po->status < 5 )
                                ...
                                <div class="pb-10">
                                    ...
                                    <div class="my-0">
                                        <div class="card-spacer-x pt-2">
                                                ...
                                                <span> Requesting Department:</span> <b class="text-warning"
                                                id="requesting_dept"></b>
                                                <br>
                                            ...
                                            <br>
                                             <h4 class="font-weight-bolder text-warning"> Assignatories <i class="flaticon-edit icon-lg"></i> </h4>
                                                        ...
                                                        <div class="border p-5 row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div style="text-align: center;border-bottom: solid black 1px">
                                                                    {{ $po->prepared }}</div>
                                                                <div style="text-align: center;"><b>{{ $po->position }}</b>
                                                                </div>
                                                                <div style="text-align: center;">
                                                                    <b>{{ Carbon\Carbon::parse($po->created_at)->format('M d, Y H:i A') }}</b>
                                                                </div>
                                                            </div>

                                                            <div class="col-6">
                                                                {{-- approve details --}}
                                                                @if (isset($po->approved))
                                                                    <p class="font-size-lg col-12">
                                                                        Approved By:
                                                                    </p>
                                                                    <div style="text-align: center;border-bottom: solid black 1px">
                                                                        {{ $po->approved }}</div>
                                                                    <div style="text-align: center;"><b>{{ $po->approved_position }}</b>
                                                                    </div>
                                                                    <div style="text-align: center;">
                                                                        <b>{{ Carbon\Carbon::parse($po->date_approved)->format('M d, Y H:i A') }}</b>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                        </div>
                                ...
                                <div class="card-spacer">
                                    <form method="POST" id="comment-form" enctype='multipart/form-data' onsubmit="#">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <button disabled id="comment-btn" type="submit"
                    ...
                    <div class="flex-md-row-auto w-md-300px w-xl-425px ml-md-6 ml-lg-8">
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder text-warning"> Purchase Order Logs <i
                            ...
                            <div class="card-body pt-4">
                                <div class="timeline timeline-3">
                                    <div class="timeline-items"  id="PO_logs">
                                    </div>
                                </div>
                            </div>
                            {{--  --}}
                ...
                <div style="font-size:12px;font-weight: bold;" class="modal-body">
                    <form class="my-5" action="#" onsubmit="UpdatePO(event)" method="get">
                        ...
                        <div class="row my-5">
                            ...
                            <span class="col-5">
                                <select class="form-control" onchange="onchangeSupplier(this.value)"
                                    value="{{ $po->sid }}" name="supplier" id="suppplier" type="text" required
                                    @if ($po->status == 3) disabled @endif>
                                    <option value="" disabled>Select Supplier</option>
                                    @foreach ($supplier->GetAllSupplier() as $res)
                                        <option data-address="{{ $res->address }}" data-term="{{ $res->term }}"
                                            value="{{ $res->id }}">
                                            {{ $res->supplier }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="row my-5">
                            ...
                            <span class="col-5">
                                <input class="form-control" value="{{ $po->address }}" id="address" name="address"
                                    type="text" readonly>
                            </span>
                        </div>
                        <div class="row my-5">
                            ...
                            <span class="col-5">
                                <select class="form-control" id="term" value="{{ $po->term }}" name="term"
                                    type="text" required>
                                    ...
                                    <span class="col-8">
                                        <select class="form-control" name="status" type="text" required>
                                            ...
                                            @foreach ($status->getStatus() as $res)
                                                ...
                                                @if ($po->status < 6 && ( $res->id < 6 && $po->status != $res->id) )
                                                    <option value="{{ $res->id }}"> {{ $res->state }} </option>
                                                @elseif ($po->status >= 6 && ( $res->id >= 6 && $po->status != $res->id) )
                                                     <option value="{{ $res->id }}"> {{ $res->state }} </option>
                                                @endif
                           ...
                           <div class="row my-5">
                                    ...
                                    <span class="col-8">
                                        <select class="form-control" name="status" type="text" required>
                                            ...
                                            <option value="{{ $po->ATP_Status == 1 ? 7 : 8 }}">Approved</option>
                                        </select>
                                    </span>
                                </div>
                                <div class="row my-5">
    ...
    <script>
            ...
            columns: [
                {
                    ...
                    render: function(data, type, row, meta) {
                        let render=``;
                        if(status > 4){
                            render = `<b>${data.quantity} ${data.unit}</b>`;
                        }else {
                            render = `
                               <div class='row d-flex p-5'>
                                    <input type='text' onchange='UpdateQuantity(this.value,${JSON.stringify(data)})' value='${data.quantity}' style='width: 60px' class='form-control col-7'>
                                    <span class='col-2 d-flex align-items-center '><b> ${data.unit}</b></span>
                               </div>`;
                        }
                       return render;
                    }
                ...
                {
                    data: null,
                    title: "<b  class='text-nowrap'> Series </b>",
                    render: function(data, type, row) {
        ...
        $('#UpdateItems').on('shown.bs.modal', function() {
         ...
         function UpdateQuantity(qty, row) {
            let index = 0;
            index = po_items.findIndex(item => item.id === row.id);
            $("#update_orderline").show();
            $("#reset").show();
            po_items[index].quantity = parseInt(qty);
            po_items[index].updated = 1;
        ...
        function getOrderline() {
            ...
            axios.get('/get-order-line/{{ $po->id }}/null', formData).then(function(response) {
                ...
                let uniqueNames = getUniquePropertyValues(response.data, 'BranchName');
        ...
        function ApprovedPO(state,remarks) {
            let formData = new FormData();
                formData.append("poid", parseInt('{{ $po->id }}'));
                formData.append("status",state);
                formData.append("remarks", remarks);
                formData.append("uid", "{{ session()->get('user')->id }}");
        ...
        function UpdateStatus() {
            ...
            var formData = new FormData();
                ...
                formData.append("remarks", "PO Request for Approval");
                formData.append("po_items", JSON.stringify(po_items));
