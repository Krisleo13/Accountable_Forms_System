...
@section('content')
        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="d-flex flex-column flex-md-row">
                            ...
                            <div class="card-header align-items-center flex-wrap justify-content-between py-5 h-auto">
                                <div class="d-flex align-items-center my-2">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-light-success symbol-40 mr-3">
                                            <i class="flaticon2-paper text-success icon-3x"></i>
                                        </div>
                                        <div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
                                            <div class="d-flex">
                                                <span class="cursor-pointer font-size-h3 font-weight-bolder text-dark-75 text-danger">
                                ...
                                <div class="d-flex align-items-center justify-content-end text-right my-2">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center card-toolbar py-1">
                                              {{-- buttons --}}


                                            @if ($requisition->sid == 2 && session()->get('user')->branch_manager == 1 && $requisition->noted_by == null)
                                                <button data-toggle='modal' data-target='#inventory_summary' type="button"
                                                    class="btn btn-light-success mr-2">
                                                    Check Inventory <i class="flaticon-home icon-lg"></i>
                                                </button>
                                            @endif
                                            ...
                                            @if ($requisition->sid == 1)
                                                <button onclick="UpdateStatus()" type="button" class="btn btn-light-primary mr-2">
                                                    For Approval <i class="flaticon-edit-1 icon-lg"></i>
                                                </button>
                                            @else
                                                <span class="label label-lg label-light-success label-inline text-uppercase font-weight-bold py-5 mr-3" data-toggle="tooltip" data-placement="bottom" title="Requisition Status">
                                                    {{ $requisition->state }}
                                                </span>
                                            @endif
                                            {{-- buttons end --}}
                                ...
                                <div class="pb-10">
                                    ...
                                    <div class="my-0">
                                        <div class="card-spacer-x pt-2">
                                            ...
                                            <div class="bordered font-size-h5">
                                                <span>Remarks: </span>
                                            ...
                                            {{-- Assignatories --}}
                                             <span class="font-size-h4 font-weight-bolder text-warning"> Assignatories <i
                                        ...
                                        {{-- prepared details --}}
                                                <div class="col-4">
                                                    ...
                                                    <div style="text-align: center;border-bottom: solid black 1px">
                                                        {{ $requisition->prepared_by }}</div>
                                                    <div style="text-align: center;"><b>{{ $requisition->prepared_position }}</b>
                                                    </div>
                                                    <div style="text-align: center;">
                                                        <b>{{ Carbon\Carbon::parse($requisition->created_at)->format('M d, Y H:i A') }}</b>
                                                    </div>
                                                </div>
                                        <br>
                                        <br>
                                        {{-- Noted --}}
                                         ...
                                         <div class="col-4">
                                            ...
                                            @if ($requisition->sid >1 && isset($requisition->notedby))
                                                <div style="text-align: center;border-bottom: solid black 1px">
                                                    {{ $requisition->notedby }}</div>
                                                <div style="text-align: center;"><b>{{ $requisition->noted_position }}</b>
                                                </div>
                                                <div style="text-align: center;">
                                                    <b>{{ Carbon\Carbon::parse($requisition->date_noted)->format('M d, Y H:i A') }}</b>
                                                </div>
                                            @elseif (session()->get('user')->branch_manager == 1 && $requisition->sid ==2 )
                                                <div class="row">
                                                    <div class="col-4">
                                                    </div>

                                                    <div class="col-8">
                                                        <button type="button" class="btn btn-light-success mr-2" onclick="NotedRequisition(17,'Approved')">
                                                            <i class="flaticon-like icon-lg"></i>
                                                        </button>

                                                        <button type="button" class="btn btn-light-danger mr-2" onclick="NotedRequisition(1,'Disapproved')">
                                                            <i class="flaticon-like icon-lg" style="transform: scaleY(-1);"></i>
                                                        </button>
                                                    </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            @if (isset($requisition->approved_by) )

                                            @if ($requisition->sid == 3 && session()->get('user')->regional_manager == 1 && isset($requisition->approved_by))
                                                <div style="text-align: center;border-bottom: solid black 1px">
                                                    {{ $requisition->approved_by }}
                                                </div>

                                                <div style="text-align: center;"><b>{{ $requisition->approved_position }}</b>
                                                </div>

                                                <div style="text-align: center;">
                                                    <b>{{ Carbon\Carbon::parse($requisition->date_approved)->format('M d, Y H:i A') }}</b>
                                                </div>
                                            @else
                                                <div class="row">
                                                    <div class="col-4">
                                                    ...
                                                    <div class="col-8">
                                                        <button type="button" class="btn btn-success mr-2" onclick="ApprovedRequisition(17,'Approved')">
                                                            <i class="flaticon-like icon-lg"></i>
                                                        </button>

                                                        <button type="button" class="btn btn-danger mr-2" onclick="ApprovedRequisition(21,'Disapproved')">
                                                            <i class="flaticon-like icon-lg" style="transform: scaleY(-1);"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            @endif
                                        @else
                                            @if ($requisition->sid == 2 && session()->get('user')->regional_manager == 1 && $requisition->noted_by != null)
                                            <div class="row">
                                                  <div class="col-4">
                                                  </div>
                                                <div class="col-8">
                    ...
                    <div class="flex-md-row-auto w-md-100px w-xl-425px ml-md-6 ml-lg-8">
                        <div class="card card-custom gutter-b">

                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder text-warning"> Purchase Request Logs <i
                            ...
                            <div class="card-body pt-4">
                                <div class="timeline timeline-3">
                                    <div class="timeline-items"  id="requisition_logs">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row my-5">
                                            ...
                                            <span class="col-6">
                                                <select class="form-control" name="to" type="text"
                                                    @if ($requisition->sid == 3) disabled @endif required>
                                                    <option value=""></option>
                                                    @foreach ($department->GetDeparment() as $res)
                                                        @if ($res->role == 1)
                                        ...
                                        <input type="hidden" name="reqid" id=""
    ...
    <div class="modal fade" id="Noted" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" id="modal-body" role="document">
            <div class="modal-content">
                <div class="modal-header ribbon ribbon-left">
                    <div class="ribbon-target bg-success font-weight-bold font-size-h6 mt-2"
                        style="top: 10px; left: -2px;"> Recomending Approval </div>
    ...
    {{-- Inventory Summary --}}
    <div class="modal fade" id="inventory_summary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" id="modal-body" role="document">
            <div class="modal-content">
                <div class="modal-header ribbon ribbon-left">
                    <div class="ribbon-target bg-success font-weight-bold font-size-h6 mt-2"
                        style="top: 10px; left: -2px;"> {{$requisition->from_branch}} Inventory Summary </div>
                ...
                {{-- content --}}
                <div class="modal-body">
                    <table class="table table-hover table-lg table-head-custom table-head-bg table-bordered table-vertical-center" id="inventory_summary_tbl">
...
@section('script')
    <script>
        ...
        let status_id= parseInt('{{$requisition->sid}}');
        ...
        let requisition_table = $('#req_id').DataTable({
            ...
            columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        let render = ``;
                        if (status_id != 3){
                            render = `<b><input class='form-control' id="qty${data.id}" onchange='UpdateQuantity(this.value,${JSON.stringify(data)})' value="${data.quantity}" min=1 type=number @if ($requisition->sid == 3) disabled @endif/></b>`;
                        }else{
                            render = `<b class='text-primary'>${data.quantity}</b>`;
                        }
                        return render;
                    }
                },
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        let render=``;
                        if(status_id != 3){
                            render = `<b class='text-primary'><input class='form-control w-auto' id="series${data.id}" onchange='UpdateSeriesNo(this.value,${JSON.stringify(row)})' value="${data.series_no}" min=1 type=number @if ($requisition->sid == 3) disabled @endif/></b>`;
                        }else{
                            render = `<b class='text-primary'>${data.series_no}</b>`;
                        }
                        return render;
                    }
                },
        ...
        let inventory_summary_table = $('#inventory_summary_tbl').DataTable({
            responsive: false,
            Destroy: true,
            paging: false,
            searching: false,
            ...
            columns: [{
                ...
                {
                    data: null,
                    title: "<b class='text-nowrap'> On Hand Qty. </b>",
                    render: function(data, type, row) {
                        if (data.hasOwnProperty('id')) {
                            return `<b>${data.description}</b>`;

                        } else {
                            return `<b class='text-success'>${data.onhand_qty}</b>`;
                        }
        ...
        $("#inventory_summary").on("shown.bs.modal", function () {
            // Initialize or redraw the DataTable here
            $("#inventory_summary_tbl").DataTable().draw();
        });

        function  renderInventorySummary(data) {
            inventory_summary_table.search('').columns().search('').clear().draw();
            inventory_summary_table.rows.add(data).draw(true);
        ...
        function UpdateStatus() {
            ...
            var formData = new FormData();
             ...
             formData.append("remarks", "Request for Approval");
        ...
        function getInventorySummary() {
            axios.get(`/get-inventory-summary/{{$requisition->branch_from}}`, formData).then(function(response) {
                  renderInventorySummary(response.data);
                    $("#update_orderline").hide();
                    $("#reset").hide();
                })
                .catch(function(error) {
        ...
        function ApprovedRequisition(state,response) {
            event.preventDefault();
            var form = event.target; // Get the form element
            var formData = new FormData();
            formData.append("reqid", parseInt('{{$requisition->id}}'));
            formData.append("status",state);
            formData.append("remarks", "Request "+response);
            formData.append("uid",  parseInt("{{ session()->get('user')->id }}"));

               Swal.fire({
                    title: "Are you sure you want to "+response+" this?",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonText: "Confirm"
                    }).then(function(result) {
        ...
        function NotedRequisition(state,response) {
            event.preventDefault();
            var form = event.target; // Get the form element
            var formData = new FormData();
            formData.append("reqid", parseInt('{{$requisition->id}}'));
        ...
        function appendRequisitionlogs(data) {
            ...
            <div class="timeline-item">
                <div class="timeline-media bg-light-primary">
                      <i class="fab fa-buffer text-primary"></i>
                </div>
                <div class="timeline-content">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="mr-2">
                            <b class="text-dark-75 text-hover-primary font-weight-bold">${ value.name }</b>
                            <span class="text-muted ml-2">${moment(value.created_at).format("MMMM DD, YYYY HH:mm A")} </span><br>
                            <span class="text-nowrap label label-info font-weight-bolder label-inline ml-2">${ value.state }</span>
                        </div>
                    </div>
